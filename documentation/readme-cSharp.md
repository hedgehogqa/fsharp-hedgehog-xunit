...
* [ParameterGeneratorBaseType]()  Control what generator is used on a parameter by parameter basis. configure 
...
```
 ...
 Using the `ParameterGeneratorBaseType` attribute is would look like [this](/examples//csharp-examples//attribute-based-parameter-comparison/PositiveAndNegativeSimpleAttribute.cs):
