...
### `Property` attribute
---
* Methods with the `Property` attribute have their arguments automatically generated by [`GenX.auto`](https://github.com/hedgehogqa/fsharp-hedgehog-experimental/#auto-generation); the generator used can be customised by either [AutoGenConfig](#autogenconfig) or [GenAttribute](#GenAttribute)
